export const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/RockySheoran/Real-time-cheat-app?tab=readme-ov-file",
    live: "https://chat-app1-fx7t.onrender.com/"
  },
  // {
  //   id: 7,
  //   title: "Country Tour",
  //   description: "Provides detailed data on populations, capitals, and unique facts about countries.",
  ...
  //   description: "Frontend featuring responsive design, intuitive navigation, and cart functionality.",
  ...
  //   id: 9,
  //   title: "Pokemon Cards",
  //   description: "Displays Pokemon species details including stats, abilities, and characteristics.",
  //   tags: ["React", "API", "Tailwind CSS"],
  //   image: "/image/p.png",
