...
const skills = [
  ...
  {
    name: "Next.js",
    icon: <SiNextdotjs className="h-6 w-6 text-gray-900 dark:text-gray-100" />,
    category: "frontend",
  },
  {
    name: "React",
  ...
  {
    name: "Node.js",
    icon: <Cpu className="h-6 w-6 text-[#339933]" />,
    category: "backend",
  },
  {
    name: "Express",
    icon: <SiExpress className="h-6 w-6 text-gray-800 dark:text-gray-200" />,
    category: "backend",
  },
  {
    name: "REST API",
  ...
  {
    name: "MongoDB",
    icon: <SiMongodb className="h-6 w-6 text-[#47A248]" />,
    category: "database",
  },
  {
    name: "SQL",
    icon: <SiMysql className="h-6 w-6 text-[#4479A1]" />,
    category: "database",
  },
  {
    name: "PostgreSQL",
    icon: <SiPostgresql className="h-6 w-6 text-[#336791]" />,
    category: "database",
  },
  {
    name: "Redis",
  ...
  {
    name: "Git",
    icon: <GitFork className="h-6 w-6 text-[#F05032]" />,
    category: "tool",
  },
  {
    name: "Docker",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Technologies I've mastered and tools I use to build amazing digital
            experiences
          </motion.p>
        </motion.div>
